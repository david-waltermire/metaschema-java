 ...
 * function.
 */
public final class FnMonthFromDate {
  private static final String NAME = "month-from-date";
  @NonNull
  static final IFunction SIGNATURE = IFunction.builder()
      ...
      .returnZeroOrOne()
      .functionHandler(FnMonthFromDate::execute)
      .build();

  private FnMonthFromDate() {
  ...
  private static ISequence<IIntegerItem> execute(@NonNull IFunction function,
      ...
      IItem focus) {
    IDateItem arg = IDateItem.type().ofTypeOrNull(arguments.get(0).getFirstItem(true));
    return arg == null
